...
const char *comment_keywords[COMMENT_KEYWORDS_COUNT] = {
    "TODO",  "NOTE",    "FIXME",      "REVIEWME", "HACK",     "REMOVEME",
    "MAYBE", "EXAMPLE", "REFACTORME", "HERE",     "IMPROVEME"};
...
const char *py_keywords[PY_KEYWORDS_COUNT] = {
    "and",    "args",      "as",     "assert",       "break",       "class",
    "cls",    "continue",  "def",    "del",          "elif",        "else",
    "except", "Exception", "False",  "finally",      "for",         "from",
    "global", "if",        "import", "in",           "__init__",    "is",
    "kwargs", "lambda",    "None",   "nonlocal",     "not",         "or",
    "pass",   "raise",     "return", "self",         "True",        "try",
    "while",  "with",      "yield",  "staticmethod", "classmethod", "print"};
